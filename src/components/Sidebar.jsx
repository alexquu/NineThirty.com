...
const Sidebar = () => {
  ...
  return (
    <nav
      className={`${isSidebarOpen ? "sidebar" : "hideSidebar"}`}
      onClick={() => {
    ...
    >
      ...
      <ul className="sidebarUl">
        ...
        <Link to={"/News"}>
          <li className="sidebarLi">NEWS</li>
        </Link>
        <Link to={"/Gigs"}>
          <li className="sidebarLi">GIGS</li>
        </Link>
        <Link to={"/Bio"}>
          <li className="sidebarLi">BIO</li>
        </Link>
        <Link to={"/Media"}>
          <li className="sidebarLi">MEDIA</li>
        </Link>
        <Link to={"/Contact"}>
          <li className="sidebarLi">CONTACT</li>
        </Link>
      </ul>
